...
_LAZY_IMPORTS = {
    ...
    "SignalTrainingDatasetBase": ("gradiend.trainer", "SignalTrainingDatasetBase"),
    "GradientTrainingDataset": ("gradiend.trainer", "GradientTrainingDataset"),
    "Signal": ("gradiend.trainer", "Signal"),
    "SignalSet": ("gradiend.trainer", "SignalSet"),
    "SignalScope": ("gradiend.trainer", "SignalScope"),
    "SignalSpace": ("gradiend.trainer", "SignalSpace"),
    "SignalBatch": ("gradiend.trainer", "SignalBatch"),
    "GradientSignalExtractor": ("gradiend.trainer", "GradientSignalExtractor"),
    "ActivationSignalExtractor": ("gradiend.trainer", "ActivationSignalExtractor"),
    "SignalPairDataset": ("gradiend.trainer", "SignalPairDataset"),
    "SignalTrainer": ("gradiend.trainer", "SignalTrainer"),
    "SignalTrainerConfig": ("gradiend.trainer", "SignalTrainerConfig"),
