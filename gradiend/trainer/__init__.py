...
_LAZY_IMPORTS = {
    ...
    "SignalPairDataset": ("gradiend.trainer.signal_trainer", "SignalPairDataset"),
    "SignalTrainer": ("gradiend.trainer.signal_trainer", "SignalTrainer"),
    "SignalTrainerConfig": ("gradiend.trainer.signal_trainer", "SignalTrainerConfig"),
