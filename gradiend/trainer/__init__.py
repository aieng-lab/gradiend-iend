...
_LAZY_IMPORTS = {
    ...
    "SignalPairDataset": ("gradiend.trainer.signal", "SignalPairDataset"),
    "SignalTrainer": ("gradiend.trainer.signal", "SignalTrainer"),
    "SignalTrainerConfig": ("gradiend.trainer.signal", "SignalTrainerConfig"),
